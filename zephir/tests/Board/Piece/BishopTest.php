...
use CodingBeard\Chess\Board\Piece\Bishop;

class BishopTest extends PHPUnit_Framework_TestCase
{
    /**
     * @covers            \CodingBeard\Chess\Board\Piece\Bishop::__construct
     * @uses              \CodingBeard\Chess\Board\Piece\Bishop
     */
    public function testConstruct()
    {
        $Bishop = new Bishop(Piece::WHITE);

        $this->assertInstanceOf('CodingBeard\Chess\Board\Piece\Bishop', $Bishop);
