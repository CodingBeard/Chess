...
--
-- Host: localhost    Database: beardsite
-- ------------------------------------------------------
...
INSERT INTO `users` VALUES (1, 'Admin', 'Istrator', '1990-01-01', 'admin@admin.com',
                            '$2y$10$E4YQjXGmC2ak.8BkKuJjj.fiywpzPvH49qPUqZwHs6Ry2KNm9oDri');
...
INSERT INTO `navlinks` VALUES
  ...
  (17, 5, 0, 'Account', 'account', NULL),
  (18, 5, 0, 'logout', 'logout', NULL),
  (19, 6, 0, 'Admin', 'admin', NULL),
  (20, 6, 0, 'Account', 'account', NULL),
  (21, 6, 0, 'Logout', 'logout', NULL),
  (22, 7, 0, 'Back', 'index', NULL),
  (23, 7, 0, 'Logout', 'logout', NULL),
  (24, 3, 0, 'Content', '#', NULL),
  (25, 3, 1, 'Pages', 'admin/pages', 24),
  (26, 3, 2, 'New', 'admin/pages/new', 25),
  (27, 3, 2, 'Clear Cache', 'admin/cache/clear', 7);
